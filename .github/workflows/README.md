...
usethis::use_github_action(
  url = "https://raw.githubusercontent.com/r-wasm/actions/v3/examples/deploy-cran-repo.yml"
)
```
...
```R
usethis::use_github_action(
  url = "https://raw.githubusercontent.com/r-wasm/actions/v3/examples/release-file-system-image.yml"
)
```
